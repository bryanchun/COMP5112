...
foreach i (20k.in input3.txt)#(sample.in 1k.in 4k.in 20k.in 20k2k.in input1.txt input2.txt input3.txt input4.txt input5.txt input6.txt) 
  echo "> serial on datasets/$i" 
  ./serial/serial_smith_waterman "datasets/$i"
  foreach b (4 8 16 32)
    foreach t (32 64 128 256 512 1024)
